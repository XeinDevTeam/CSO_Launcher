...
DWORD FindPattern(PCHAR pattern, DWORD start, DWORD end, DWORD offset = 0);
DWORD FindPush(DWORD start, DWORD end, PCHAR Message);
DWORD FindMov(DWORD start, DWORD end, PCHAR Message);
DWORD GetVTablePointer(DWORD dwBase, DWORD dwSize, const char* pszClassName);
